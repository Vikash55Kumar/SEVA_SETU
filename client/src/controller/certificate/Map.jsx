  ...
  return (
    <div className="dashboard-container">
      <div className="chart-section">
        <h3 style={{fontSize:"2rem", margin:"1rem"}}>Different Types of Forms Received</h3>
        <ResponsiveContainer width="100%" height={300}>
          <BarChart data={formTypesData}>
            ...
            <Tooltip />
            <Legend />
            <Bar dataKey="FormsReceived" fill="#008FFB" />
            <Bar dataKey="PendingForms" fill="#00E396" />
            <Bar dataKey="ProcessedForms" fill="#FEB019" />

...
const EmployeeProgress = React.memo(function EmployeeProgress({ employeeProfile = {}, adminProfile = {} }) {

  const { fullName, email, avatar, officerId, employeeId } = employeeProfile || adminProfile || {}; 
  ...
  return (
    <div className='body4'>
      <div className="profile-background">
        <h2 style={{fontSize:"2rem", marginBottom:"1rem"}}>Details of Employees</h2>
        <div className="profile-container">
          <div className="menu">
            ...
            <div className="button" style={{color:"blue"}}>Task Status</div>
